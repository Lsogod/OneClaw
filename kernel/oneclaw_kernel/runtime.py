...
from .tools import KernelToolRegistry
...
class OneClawKernel:
    def __init__(self, cwd: str | None = None) -> None:
        ...
        self.tool_registry = KernelToolRegistry(self)
    ...
    def tools_info(self, summary_only: bool = False) -> dict[str, Any]:
        return self.tool_registry.info(summary_only)

    def tool_search(self, query: str, limit: int = 20) -> dict[str, Any]:
        return self.tool_registry.search(query, limit)
    ...
    def _tool_specs(self) -> list[dict[str, Any]]:
        return self.tool_registry.tool_specs()

    def _find_tool(self, name: str) -> dict[str, Any] | None:
        return self.tool_registry.find_tool(name)
