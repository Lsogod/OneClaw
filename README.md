...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-106_TS_%2B_25_Python-brightgreen" alt="Tests">
...
后续主要是生态厚度工作：更多 tool、更多 provider 真实 E2E、MCP auth/resource 复杂场景、plugin 远程来源策略强化、LSP/channels/vim/voice 等更完整的平台层。
