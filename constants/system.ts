...
const DEFAULT_PREFIX = `You are One Claw, a coding agent CLI.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are One Claw, a coding agent CLI, running within an agent SDK environment.`
const AGENT_SDK_PREFIX = `You are an agent for One Claw.`
